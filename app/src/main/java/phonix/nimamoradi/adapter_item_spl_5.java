...
public class adapter_item_spl_5 extends RecyclerView.Adapter<adapter_item_spl_5.view> {
    Context context;
      send_info send_info;
    ...
    public adapter_item_spl_5(Context context, send_info send_info, ArrayList<modeldate_mainpage_items> items2, int w, int h) {
        this.h = h;
        this.d = w;
...
public void click(sell sell)
{
    ...
    public class view extends RecyclerView.ViewHolder {
        ...
        public void Bind(int Pos)
        {
            ...
            txtbtnadd.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    sell.info(false,modeldate_mainpage_items);
                }
            });
    ...
    public interface sell{
        public void info(Boolean aBoolean,modeldate_mainpage_items items);
    }
}
